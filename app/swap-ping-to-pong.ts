...
const contractApproveAddress = "0x9beaA0016c22B646Ac311Ab171270B0ECf23098F";
...
async function claim() {
  for (let index = 0; index < wallets.length; index++) {
    ...
    try {
      ...
      const params = {
        tokenIn: "0x9beaA0016c22B646Ac311Ab171270B0ECf23098F",
        tokenOut: "0x33E7fAB0a8a5da1A923180989bD617c9c2D1C493",
        fee: 500,
        recipient: address,
